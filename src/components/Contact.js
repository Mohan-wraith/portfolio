        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <Reveal delay={100}>
            ...
            <p className="text-neutral-400 leading-relaxed">
              I'm looking for my first full-time role in data science, machine
              learning, or applied research. If you have an interesting problem
              or an open position, I'd like to hear about it.
            </p>
          </Reveal>
          ...
          <Reveal delay={200}>
            <div className="space-y-3">
              ...
              <a
                ...
                className="flex items-center gap-3 p-4 rounded-xl border transition-all duration-300 group hover:-translate-y-0.5"
